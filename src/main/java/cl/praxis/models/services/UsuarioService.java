...
public class UsuarioService {
    ...
    public UsuarioDTO login(String correo, String password) {
        ...
        if (usuario != null && usuario.getPassword().equals(password)) {
            return new UsuarioDTO(usuario.getNombre(), usuario.getCorreo(), usuario.getPassword(), usuario.getNick(), usuario.getPeso());
        }
        return null;
    }
    ...
    public void registrar(UsuarioDTO usuarioDTO) {
        ...
        if (existente == null) {
            Usuario nuevoUsuario = new Usuario(usuarioDTO.getNombre(), usuarioDTO.getCorreo(), usuarioDTO.getPassword(), usuarioDTO.getNick(), usuarioDTO.getPeso());
